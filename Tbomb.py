...
def update():
    ...
    try:
        parsedData = requests.get("https://github.com/AdminShnBd/Bomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/AdminShnBd/Bomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd AdminShnBdBomber && python AdminShnBd.py")
...
def logo():
    ...
    print("\033[94m│ \033[95m𝐀𝐃𝐌𝐈𝐍 𝐒𝐇𝐍𝐁𝐃 𝐁𝐎𝐌𝐁𝐄𝐑 镍合金              \033[94m│".center(columns+15)) 
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : Admin SHN BD               \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/AdminShnBd \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Admin SHN BD               \033[37mV4.1 \033[94m│".center(columns+15))
    print("│ \033[95mTikTok : @admin.shn.bd              \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
